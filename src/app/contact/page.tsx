            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium">spatade3@gatech.edu</p>
                </div>
              </a>
              ...
              <div className="glass-card p-6 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">East Brunswick, NJ</p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium">Siddheya Patade</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium">inSideos-designs</p>
                </div>
              </a>
            </div>
          </div>
          ...
          <div className="glass-card p-6 inline-block">
            <div className="flex items-center gap-3 justify-center">
              ...
              <p className="text-gray-400">
                Currently open to <span className="text-white font-medium">Data Analytics</span> opportunities
              </p>
            </div>
          </div>
        </div>
